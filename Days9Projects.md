 ...
 * ''Sébastien Labbé'': '''Combinatorics on words'''. 
        1. Use colors and @interact of sage to study equations on words. The [http://code.google.com/p/sage-words/ sage-words package] is needed to run the following sage worksheet.
