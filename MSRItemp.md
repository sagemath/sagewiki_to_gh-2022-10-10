...
== Calendar of program events ==
 ...
 || Thu. 3 || 11-12 || Simons || Kumar Murty - Title: The field of Fourier coefficients of a modular form.
Abstract: For a normalized eigenform f of squarefree level and trivial character, we give effective bounds B(f)
so that for some prime p < B(f), the p-th Fourier coefficient generates the field generated by the Fourier coefficients of f. (members seminar) ||
