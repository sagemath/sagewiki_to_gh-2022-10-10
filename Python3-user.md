Warning:  |  Starting from version 9.0,  the default distributed version of Sage is using Python 3. See <a href="/python3-switch">Python3-Switch</a> for more information.
