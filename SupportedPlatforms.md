 ...
 * 1) Fully supported - Sage is ALWAYS checked on ALL these platforms before a release is made.
 * 2) Almost fully supported - Sage is tested on these platforms, but there are some known issues.  However, most functionality of Sage should still work.
 * 3) Expected to work -  Sage will probably work, but it is not always tested.
