...
* The base version of SAGE we'll start with is **2.10.2.alpha0**, but be sure to apply the patch here: 
            * <a href="http://trac.sagemath.org/sage_trac/attachment/ticket/1963/Sage-2.10.2.alpha1-fix-import-issue.patch">http://trac.sagemath.org/sage_trac/attachment/ticket/1963/Sage-2.10.2.alpha1-fix-import-issue.patch</a> 
            * and make sure to apply the fix from <a class="http" href="http://trac.sagemath.org/sage_trac/ticket/2172">#2172</a>. 
* <a href="/bug10/status">STATUS</a> 
* <a href="/bug10/irc">IRC log</a> 
...
1. Michael Abshoff (memory leaks, ports) 
1. David Joyner (minor Bessel function bug, minor tutorial edits, maybe coding theory improvements) 
1. Burcin Erocal (<a href="/PolyBoRi">PolyBoRi</a> interface problems - 0.2 package, infinity, special functions)  
1. Yi Qiang (Getting dsage doctest integration in) 
1. Clément Pernet (linear algebra related bugs, memleaks) 
1. Timothy Clemans (Mathematica interface, notebook, cryptography) 
1. Craig Citro (cool stuff) 
1. Carl Witty (skim the reference manual, fix things that look wrong or badly-<a href="/LaTeXed">LaTeXed</a>) 
1. Alex Ghitza (start with #756) 
