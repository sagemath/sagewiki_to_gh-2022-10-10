...
These are the tasks that need to be accomplished, in order of importance.
 ...
 1. (done) '''Secure Separate User Process''' Create an option so that processes that run the actual worksheets can be started as a different user.  This will be slower, but could be vastly more secure.  [:days4/projects/sepuser: More about this]
