...
'''A survey of p-adic point counting''', <<Anchor(zeta2)>> ''Jan Tuitman'' (10:00-11:00, [[attachment:tuitman.pdf|slides]] [[attachment:hypell-example.txt|example1]] [[attachment:general-curve.txt|example2]])
