 ...
 * [[`javascript:window.external.AddSearchProvider("http://wiki.sagemath.org/firefox-trac?action=AttachFile&do=get&target=trac.xml")`|Click here]] to install trac.xml
