 ...
 * Risk Management: Try to anticipate potential problems and explain, how to mitigate them.
...
OTHER: There are many issues at https://github.com/sagemath/cloud/issues and other possible SMC projects.  Let use know (help@sagemath.com) if you're interested in something else involving SMC.   I like the above for a Sage GSoC project, since it would result in a code being included in Sage.
