...
|| Mentor     || Vincent Delecroix ||
|| Difficulty || Medium ||
|| Skills     || good knowledge of Python and some mathematics ||
...
Steps:
 ...
 1. Implement a generic framework for speed regression of Python modules
 2. Design a large set of Sage tests (possibly asking for contribution on sage-devel)
 3. Set up a server whose object would be to check for speed regression (or progression) of Sage code
