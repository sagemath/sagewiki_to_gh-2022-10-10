...
for Sage. Specific projects here would as follows:
  ...
  * Implement an efficient algorithm for modular decomposition of graphs in Python, e.g.
extending [[https://networkx.github.io/|NetworkX]] or using a Sage graph backend.
