...
Currently Sage has support for the field of p-adic numbers ($\QQ_p$)and their extensions when they are presented as a compositum of a totally ramified extension on top of a unramified extension of $\QQ_p$. The goal of this project is:
