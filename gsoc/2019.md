...
|| Area       || Software packaging and distribution, modularization ||
|| Skills     || UNIX skills, experience with software distribution systems on targeted platforms ||

Currently Sagemath is distributed either as semi-complete source/binary blob, with exception of few Linux
distributions, in particular Debian [[https://wiki.debian.org/DebianScience/Sage]], which an effort of stripping out components already provided, and modularize the rest. Building on this experience, we would like to see Sagemath available
within   
