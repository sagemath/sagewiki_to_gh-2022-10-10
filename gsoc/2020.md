 ...
 2. '''more data types'''
    ...
    * Making numpy arrays support more types such as
      ...
      * intervals ([[https://gforge.inria.fr/projects/mpfi/|MPFI]] `mpfi_t`) and balls ([[http://arblib.org/|arb]] `arb_t` and `acb_t`)
      ...
      An examples of such implementation are the [[https://github.com/moble/quaternion|quaternions]].
...
For all of these tasks, it would be interesting to see whether [[https://docs.sympy.org/latest/modules/codegen.html|sympy codegen]], [[https://github.com/symengine/symengine|symengine]] or the (now abandoned) project [[http://deeplearning.net/software/theano/|Theano]] can be used.
