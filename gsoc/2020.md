 ...
 * For the two above items, see how much can be used from the Python library [[http://deeplearning.net/software/theano/|Theano]]
 ...
 * Making this tool available independently of SageMath as a Python library (possibly contributing to [[http://deeplearning.net/software/theano/|Theano]])
