...
For all of these tasks, it would be interesting to see whether [[https://docs.sympy.org/latest/modules/codegen.html|sympy codegen]] and [[https://github.com/symengine/symengine|symengine]] can be used to replace `fast_callable`.

The (now abandoned) project [[http://deeplearning.net/software/theano/|Theano]] might also be of interest for optimization.
