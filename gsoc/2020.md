...
For all of these tasks, it would be interesting to see whether [[https://docs.sympy.org/latest/modules/codegen.html|sympy codegen]] or the (now abandoned) project [[http://deeplearning.net/software/theano/|Theano]] can be used.
