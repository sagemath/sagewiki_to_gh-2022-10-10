...
We have currently several methods to plot graphs, but all these methods lack of flexibility and functionalities. For instance, it is currently not possible to specify the width of a given edge when using our interface to [[https://d3js.org|d3.js]]. The aim of this project is to improve the drawing functionalities of graphs.
