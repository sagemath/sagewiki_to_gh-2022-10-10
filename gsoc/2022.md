...
|| Skills     || Basic math background in algebra and analysis. Fluent in Python and C/C++. Kowledge of compilers, Cython, or parallelization (openmp) would be interesting. ||
|| Length     || Long-term ||
