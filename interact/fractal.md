...
```
![interact/fractal/binomial.png](interact/fractal/binomial.png) 
...
```
![interact/fractal/1.png](interact/fractal/1.png) 
...
```
![interact/fractal/2.png](interact/fractal/2.png) 
...
```
![interact/fractal/3.png](interact/fractal/3.png) 

![interact/fractal/4.png](interact/fractal/4.png) 
...
```
![interact/fractal/mandelbrot_cython.png](interact/fractal/mandelbrot_cython.png) 


## Mandelbrot & Julia Interact with variable exponent

published notebook: <a class="https" href="https://cloud.sagemath.com/projects/19575ea0-317e-402b-be57-368d04c113db/files/pub/1201-1301/1299-Mandelbrot.sagews">https://cloud.sagemath.com/projects/19575ea0-317e-402b-be57-368d04c113db/files/pub/1201-1301/1299-Mandelbrot.sagews</a> 
...
```
![interact/fractal/mandel-interact-02.png](interact/fractal/mandel-interact-02.png) 
### Julia
...
```
![interact/fractal/julia-interact-01.png](interact/fractal/julia-interact-01.png) 
```txt
julia_plot(-7,30,0.5,0.5,(-1.5,1.5), (-1.5,1.5))
```
![interact/fractal/julia-fractal-exponent--7.png](interact/fractal/julia-fractal-exponent--7.png) 
...
```
![interact/fractal/sierpinski.png](interact/fractal/sierpinski.png) 
