...
For the latext changes see [http://sagemath.org/announce/sage-2.10.1.txt sage-2.10.1.txt]. In addition to many bug fixes, integration of new packages, and speedups, we have the following cool new features.  This list is incomplete; see the release notes for more details.
